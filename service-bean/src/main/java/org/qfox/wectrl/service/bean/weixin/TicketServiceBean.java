        ...
        synchronized (appID.intern()) {
            ...
            if (ticket == null || ticket.isExpired()) {
                ...
                if (ticket == null || ticket.isExpired()) {
                    ...
                    Message<TicketApiResult> message = WeixinCgiBinAPI.INSTANCE.ticket(token.getAccess_token(), org.qfox.wectrl.service.weixin.cgi_bin.TicketType.jsapi);
        ...
        synchronized (appID.intern()) {
            ...
            if (ticket == null || ticket.isExpired()) {
                ...
                if (ticket == null || ticket.isExpired()) {
                    ...
                    Message<TicketApiResult> message = WeixinCgiBinAPI.INSTANCE.ticket(token.getAccess_token(), org.qfox.wectrl.service.weixin.cgi_bin.TicketType.wx_card);
                    TicketApiResult result = null;
                    if (message != null && message.isSuccess()) {
                        result = message.getEntity();
                    } else {
