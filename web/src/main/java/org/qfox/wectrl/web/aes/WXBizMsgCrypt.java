...
public class WXBizMsgCrypt {
     ...
     * </ol>
     *
     * @param msg 公众平台待回复用户的消息，xml格式的字符串
     ...
     * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
     */
    public String encryptMsg(String msg, String timestamp, String nonce) throws AesException {
        // 加密
        String encrypt = encrypt(getRandomString(), msg);
        ...
        String msgSignature = SHA1.sign(token, timestamp, nonce, encrypt);

        // 生成发送的xml
        String result = XMLParse.generate(encrypt, msgSignature, timestamp, nonce);
        return result;
    }
     ...
     * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
     */
    public String decryptMsg(String msgSignature, String timestamp, String nonce, String body) throws AesException {

        // 提取密文
        Object[] encrypt = XMLParse.extract(body);

        // 验证安全签名
        String signature = SHA1.sign(token, timestamp, nonce, encrypt[1].toString());
