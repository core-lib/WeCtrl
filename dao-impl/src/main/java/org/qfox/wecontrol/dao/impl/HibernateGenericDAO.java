package org.qfox.wecontrol.dao.impl;
...
public abstract class HibernateGenericDAO<T extends Serializable, PK extends Serializable> extends HibernateDaoSupport implements GenericDAO<T, PK> {
    // 实体类类型(由构造方法自动赋值)
