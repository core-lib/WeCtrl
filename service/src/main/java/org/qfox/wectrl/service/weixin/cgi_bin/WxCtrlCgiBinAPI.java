...
public interface WxCtrlCgiBinAPI {
    ...
    WxCtrlCgiBinAPI INSTANCE = Client.builder().setProtocol("http").setHost("api.wujiexiankeji.com").setConnTimeout(200 * 1000).setContentCharsets("UTF-8").addPlugins("characterEncodingPlugin; charset=UTF-8").build().create(WxCtrlCgiBinAPI.class);
